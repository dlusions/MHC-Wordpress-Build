<?php // $file = /nas/content/live/mhc2025dev/wp-content/plugins/yooessentials/modules/form-elements/form_checkbox/element.json
...
return [
  ...
  'icon' => $filter->apply('url', '~yooessentials_url/modules/form-elements/form_checkbox/icon.svg', $file), 
  'iconSmall' => $filter->apply('url', '~yooessentials_url/modules/form-elements/form_checkbox/icon.svg', $file), 
  'element' => true, 
  'container' => true, 
  'submittable' => true, 
  'width' => 500, 
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          'title' => 'Content', 
          'fields' => ['control_name', 'control_value', 'control_required', 'control_min', 'control_max', 'control_error_message', 'control_options']
        ], [
          'title' => 'Field', 
