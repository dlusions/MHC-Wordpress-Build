<?php // $file = /nas/content/live/mhc2025dev/wp-content/plugins/yooessentials/modules/form-elements/form_input_time/element.json

return [
  '@import' => $filter->apply('path', './element.php', $file), 
  'name' => 'yooessentials_form_input_time', 
  'title' => 'Time', 
  ...
  'fields' => [
    ...
    'control_mintime' => $config->get('yooessentials.form.fields.control_mintime'), 
    'control_maxtime' => $config->get('yooessentials.form.fields.control_maxtime'), 
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          'title' => 'Content', 
          'fields' => ['control_name', 'control_value', 'control_required', 'control_mintime', 'control_maxtime', 'control_error_message']
        ], [
          'title' => 'Field', 
