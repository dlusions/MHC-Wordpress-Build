<?php // $file = /nas/content/live/mhc2025dev/wp-content/plugins/yooessentials/modules/element/elements/chart/element.json
    ...
    'default' => [
      ...
      'fields' => [[
          ...
          'fields' => [[
              ...
              'description' => 'Set JavaScript expressions to compose the Tooltip content. Use <code>item</code> and <code>items</code> as context, e.g. <code>item.raw + \'suffix\'</code>, <code>item.dataset.label + \'suffix\'</code> or <code>item.metadata</code>. To completely disable this callback rendering set an explicit empty string <code>\'\'</code>. Consult the <a href="https://www.chartjs.org/docs/latest/configuration/tooltip.html#tooltip-callbacks" target="_blank">Chart.js guide</a> for further reference.', 
              'type' => 'group', 
              'divider' => true, 
              ...
              'type' => 'group', 
              'divider' => true, 
              'description' => 'Set JavaScript expressions to compose the ticks content. Use the <code>label</code>, <code>value</code>, <code>index</code> and <code>ticks</code> as context, e.g. <code>label + \'suffix\'</code>. Consult the <a href="https://www.chartjs.org/docs/latest/axes/labelling.html#creating-custom-tick-formats" target="_blank">Chart.js guide</a> for further reference.', 
