<?php // $file = /nas/content/live/mhc2025dev/wp-content/themes/yootheme-child/builder/form_recaptcha/element.json

return [
  '@import' => $filter->apply('path', './element.php', $file), 
  'name' => 'accessitree_form_recaptcha', 
  'title' => 'reCAPTCHA AccessiTREE', 
