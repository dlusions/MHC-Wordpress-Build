<?php // $file = /nas/content/live/mhc2025dev/wp-content/plugins/yooessentials/modules/element/elements/chart_dataset/element.json
...
return [
  ...
  'defaults' => [
    ...
    'dataset_lineTension' => 0, 
    'dataset_barPercentage' => 0.9
  ], 
  'placeholder' => [
    'children' => [[
  ...
  'fields' => [
    ...
    'dataset_type' => [
      'label' => 'Type', 
      'description' => 'Inherit or set a specific chart type for this dataset.', 
      'type' => 'select', 
      'options' => [
        'Inherit' => '', 
        'Line' => 'line', 
    ...
    'dataset_fill' => [
      ...
      'enable' => 'dataset_type == \'line\' || dataset_type == \'radar\''
    ], 
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          'title' => 'Content', 
          'fields' => ['dataset_type', 'dataset_label', 'data']
        ], [
          'title' => 'Settings', 
          'fields' => [[
              'label' => 'General', 
              ...
              'fields' => ['dataset_borderWidth', 'dataset_borderColor', 'dataset_backgroundColor']
            ], [
              'label' => 'Bar', 
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['dataset_barPercentage']
            ], [
              'label' => 'Line', 
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['dataset_showLine', 'dataset_fill', 'dataset_lineTension']
            ]]
