<?php // $file = /nas/content/live/mhc2025dev/wp-content/plugins/yooessentials/modules/element/elements/chart_data/element.json
...
return [
  ...
  'fields' => [
    'label' => [
      'label' => 'Label', 
      'source' => true, 
      'description' => 'The label for this entry.'
    ], 
    'data' => [
      'label' => 'Data', 
      'description' => 'The data for this entry.', 
      'attrs' => [
        'type' => 'number'
      ], 
      'source' => true
    ...
    'metadata' => [
      'label' => 'Metadata', 
      'description' => 'Additional data that could be displayed in a tooltip or others.', 
      'source' => true
    ], 
    'backgroundColor' => [
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          'title' => 'Content', 
          'fields' => ['label', 'data', 'metadata', 'backgroundColor', 'borderColor']
