<?php // $file = /nas/content/live/mhc2025dev/wp-content/plugins/yooessentials/modules/form-elements/form_input_date/element.json

return [
  '@import' => $filter->apply('path', './element.php', $file), 
  'name' => 'yooessentials_form_input_date', 
  'title' => 'Date', 
  ...
  'fields' => [
    ...
    'control_mindate' => $config->get('yooessentials.form.fields.control_mindate'), 
    'control_maxdate' => $config->get('yooessentials.form.fields.control_maxdate'), 
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          'title' => 'Content', 
          'fields' => ['control_name', 'control_value', 'control_required', 'control_mindate', 'control_maxdate', 'control_error_message']
        ], [
          'title' => 'Field', 
