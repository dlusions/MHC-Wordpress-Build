<?php // $file = /nas/content/live/mhc2025dev/wp-content/plugins/yooessentials/modules/form-elements/form_input_week/element.json

return [
  '@import' => $filter->apply('path', './element.php', $file), 
  'name' => 'yooessentials_form_input_week', 
  'title' => 'Week', 
  ...
  'fields' => [
    ...
    'control_minweek' => $config->get('yooessentials.form.fields.control_minweek'), 
    'control_maxweek' => $config->get('yooessentials.form.fields.control_maxweek'), 
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          'title' => 'Content', 
          'fields' => ['control_name', 'control_value', 'control_required', 'control_minweek', 'control_maxweek', 'control_error_message']
        ], [
          'title' => 'Field', 
