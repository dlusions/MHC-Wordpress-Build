<?php // $file = /nas/content/live/mhc2025dev/wp-content/themes/yootheme/packages/builder-wordpress/elements/module/element.json
...
return [
  ...
  'fields' => [
    ...
    'list_style' => [
      ...
      'show' => '$match(type, \'recent-posts|pages|recent-comments|archives|categories|meta\')'
    ], 
    'link_style' => [
      'label' => 'Link Style', 
