<?php // $file = /nas/content/live/mhc2025dev/wp-content/plugins/jp_ce_accordion_pro/elements/elements/accordion_pro/element.json

return [
  '@import' => $filter->apply('path', './element.php', $file), 
  'name' => 'accordion_pro', 
  'title' => 'JP CE Accordion Pro', 
  'group' => 'JPro Studio', 
  ...
  'fields' => [
    ...
    'heading_border_width' => [
      'label' => 'Heading Border Width(Px)', 
      'type' => 'text', 
      'default' => '1', 
      'show' => 'custom_style == \'custom\''
    ], 
    ...
    'heading_icon_bg' => [
      'label' => 'Heading Icon Background Color', 
      'type' => 'color', 
      'default' => '#ffffff', 
      'show' => 'custom_style == \'custom\''
    ], 
    ...
    'heading_active_icon' => [
      'label' => 'Active Heading Icon', 
      'type' => 'image', 
      'show' => 'custom_style == \'custom\''
    ], 
    'heading_icon_align' => [
      'label' => 'Heading Icon Align', 
      'type' => 'select', 
      'default' => 'right', 
      'options' => [
        'Right' => 'right', 
    ...
    'heading_icon_padding' => [
      'label' => 'Left Right Padding for Icon ', 
      'type' => 'text', 
      'default' => '10', 
      'show' => 'custom_style == \'custom\''
    ], 
    'heading_padding' => [
      'label' => 'Heading Padding(px)', 
      'type' => 'text', 
      'default' => '15', 
      'show' => 'custom_style == \'custom\''
    ], 
    'heading_icon_transition' => [
      'label' => 'Heading Icon Transition', 
      'type' => 'select', 
      'default' => 'none', 
      'options' => [
        'None' => 'none', 
      ...
      'enable' => 'custom_style == \'custom\' && heading_icon'
    ], 
    'content_border' => [
    ...
    'title_element' => [
      'label' => 'Title Element', 
      'description' => 'Choose one of the HTML elements to fit your title.', 
      'type' => 'select', 
      'default' => 'h3', 
      'options' => [
        'h1' => 'h1', 
    ...
    'scrollto' => [
      'type' => 'checkbox', 
      'label' => 'Scroll to Accordion on Page load', 
      'text' => 'Yes'
    ], 
    'scroll_event' => [
      'label' => 'Scroll Event', 
      ...
      'options' => [
        'Always' => 'always', 
        'Hashtag or Active Session' => 'session'
      ], 
      'enable' => 'scrollto'
    ], 
    'scroll_duration' => [
    ...
    'scroll_offset' => [
      'label' => 'Offset Value (+100, -100 etc)', 
      'default' => '-100', 
      'enable' => 'scrollto'
    ], 
    'enable_url' => [
      'type' => 'checkbox', 
      'label' => 'Enable Switch URL', 
      'text' => 'Yes'
    ], 
    'show_reme2' => [
      'description' => ' Unique ID for items needed for url. kindly update unque ids in items.', 
      'type' => 'label'
    ], 
    'show_reme' => [
      'description' => 'We used joomla session for remember tab. Please give Unique ID in above field for example: customtab_1. And please make sure do not use same id in same page.<hr class="uk-margin-small-top uk-margin-remove-bottom " >', 
      'type' => 'label'
    ], 
    'remember_tab' => [
      'type' => 'checkbox', 
      'label' => 'Remember Last Used Tab', 
      'descrition' => 'We used Wordpress session for store active tab', 
      'text' => 'Yes'
    ], 
    'uniqueid' => [
      'label' => 'Unique ID', 
    ...
    'css' => [
      'label' => 'CSS', 
      'description' => 'Enter your own custom CSS. The following selectors will be prefixed automatically for this element: <code>.el-accordion-title</code>, <code>.el-item</code>, <code>.el-title</code>', 
      'type' => 'editor', 
      'editor' => 'code', 
      'mode' => 'css', 
      'attrs' => [
    ...
    'default' => [
      ...
      'fields' => [[
          ...
          'fields' => [[
              ...
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['multiple', 'collapsible', 'scrollto', 'scroll_event', 'scroll_duration', 'scroll_offset', 'enable_url']
            ], 'show_reme2', [
              'label' => 'Session Settings', 
              'type' => 'group', 
              'divider' => false, 
              'fields' => ['remember_tab', 'uniqueid']
            ], 'show_reme', [
              'label' => 'Title', 
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['title_element', 'title_style', 'title_font_family', 'title_color']
            ], [
              'label' => 'Style', 
              'type' => 'group', 
              'divider' => true, 
              ...
              'label' => 'Heading Custom Style', 
              'type' => 'group', 
              'divider' => true, 
              'show' => 'custom_style == \'custom\'', 
              'fields' => ['heading_icon', 'heading_active_icon', 'heading_icon_align', 'heading_icon_width', 'heading_icon_padding', 'heading_padding', 'heading_border_width', 'heading_border', 'heading_bg', 'heading_color', 'heading_icon_bg', 'heading_icon_transition']
            ], [
              'label' => 'Content Custom Style', 
              'type' => 'group', 
              'divider' => true, 
              'show' => 'custom_style == \'custom\'', 
              'fields' => ['content_margin_top', 'content_padding', 'content_border_width', 'content_border', 'content_bg', 'content_color']
            ], [
              'label' => 'Content', 
              'type' => 'group', 
              'divider' => true, 
              ...
              'fields' => [[
                ...
                ], 'image_loading', 'image_border', 'image_box_shadow', 'image_align', 'image_grid_width', 'image_grid_column_gap', 'image_grid_row_gap', 'image_grid_breakpoint', 'image_vertical_align', 'image_margin', 'image_svg_inline', 'image_svg_color']
            ], [
              'label' => 'Link', 
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['link_text', 'link_aria_label', 'link_target', 'link_style', 'link_size', 'link_fullwidth', 'link_margin']
            ], [
              'label' => 'General', 
              'type' => 'group', 
