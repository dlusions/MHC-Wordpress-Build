<?php // $file = /nas/content/live/mhc2025dev/wp-content/themes/yootheme/packages/theme-wordpress-widgets/config/widgets.json
...
return [
  'fields' => [
    ...
    'style' => [
      ...
      'show' => '!$match(this.position, \'^(toolbar-(left|right)|(logo|navbar|header)(-mobile)?|dialog(-mobile)?|debug)$\')'
    ], 
    'title_style' => [
      'label' => 'Title Style', 
