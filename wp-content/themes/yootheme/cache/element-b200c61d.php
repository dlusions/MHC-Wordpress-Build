<?php // $file = /nas/content/live/mhc2025dev/wp-content/plugins/yooessentials/modules/form-elements/form_input_month/element.json

return [
  '@import' => $filter->apply('path', './element.php', $file), 
  'name' => 'yooessentials_form_input_month', 
  'title' => 'Month', 
  ...
  'fields' => [
    ...
    'control_minmonth' => $config->get('yooessentials.form.fields.control_minmonth'), 
    'control_maxmonth' => $config->get('yooessentials.form.fields.control_maxmonth'), 
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          'title' => 'Content', 
          'fields' => ['control_name', 'control_value', 'control_required', 'control_minmonth', 'control_maxmonth', 'control_error_message']
        ], [
          'title' => 'Field', 
          'fields' => ['control_label', 'control_id_inherit', 'control_id', 'control_attrs']
        ], [
          'title' => 'Settings', 
          'fields' => [[
              'label' => 'Field', 
