...
class RemoveDuplicateLibraries extends AbstractMigration implements MigrationInterface
{
    public const VERSION = '2.2.12';

    public function migrateConfig(array $config): array
    {
        $entries = Arr::get($config, 'layout.libraries', []);
        ...
        Arr::set($config, 'layout.libraries', $entries);
