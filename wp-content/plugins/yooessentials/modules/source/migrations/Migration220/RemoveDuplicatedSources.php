...
class RemoveDuplicatedSources extends AbstractMigration implements MigrationInterface
{
    public const VERSION = '2.2.5';

    public function migrateConfig(array $config): array
    {
        $entries = Arr::get($config, 'source.sources', []);
        ...
        Arr::set($config, 'source.sources', $entries);
