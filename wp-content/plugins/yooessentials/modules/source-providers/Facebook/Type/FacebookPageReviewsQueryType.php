...
class FacebookPageReviewsQueryType extends AbstractQueryType
{
    use LoadsSourceFromArgs, CachesResolvedSourceData, HasApiRequest;

    public const NAME = 'pageReviews';
    public const LABEL = 'Page Reviews';
    public const DESCRIPTION = 'List of page reviews';

    public static function getCacheKey(): string
    {
        return 'facebook-page-reviews';
    }
    ...
    public function config(): array
    {
        return [
            'fields' => [
                $this->name() => [
                    'type' => [
                        'listOf' => FacebookReviewType::NAME,
                    ],
    ...
    public static function resolve($root, array $args): array
    {
        ...
        return self::resolveFromCache($source, $args, fn () => $api->reviews($source->pageId(), $args));
    }
}
