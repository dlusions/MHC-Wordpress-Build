...
use ZOOlanders\YOOessentials\Vendor\phpseclib\Crypt\DES;
...
class SSH1
{
    ...
    function _connect()
    {
        ...
        if (\defined('ZOOlanders\\YOOessentials\\Vendor\\NET_SSH1_LOGGING')) {
    ...
    function login($username, $password = '')
    {
        ...
        if (\defined('ZOOlanders\\YOOessentials\\Vendor\\NET_SSH1_LOGGING') && NET_SSH1_LOGGING == self::LOG_COMPLEX) {
            $data = \pack('CNa*', NET_SSH1_CMSG_AUTH_PASSWORD, \strlen('password'), 'password');
