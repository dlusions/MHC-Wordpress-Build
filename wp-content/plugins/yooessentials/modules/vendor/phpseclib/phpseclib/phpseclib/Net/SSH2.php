 ...
 */
namespace ZOOlanders\YOOessentials\Vendor\phpseclib\Net;

use ZOOlanders\YOOessentials\Vendor\phpseclib\Crypt\Base;
use ZOOlanders\YOOessentials\Vendor\phpseclib\Crypt\Blowfish;
use ZOOlanders\YOOessentials\Vendor\phpseclib\Crypt\Hash;
use ZOOlanders\YOOessentials\Vendor\phpseclib\Crypt\Random;
use ZOOlanders\YOOessentials\Vendor\phpseclib\Crypt\RC4;
use ZOOlanders\YOOessentials\Vendor\phpseclib\Crypt\Rijndael;
use ZOOlanders\YOOessentials\Vendor\phpseclib\Crypt\RSA;
use ZOOlanders\YOOessentials\Vendor\phpseclib\Crypt\TripleDES;
use ZOOlanders\YOOessentials\Vendor\phpseclib\Crypt\Twofish;
use ZOOlanders\YOOessentials\Vendor\phpseclib\Math\BigInteger;
// Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use ZOOlanders\YOOessentials\Vendor\phpseclib\System\SSH\Agent;
/**
 * Pure-PHP implementation of SSHv2.
 *
 * @package SSH2
...
class SSH2
{
    ...
    function _connect()
    {
        ...
        $extra = $matches[1];
        if (\defined('ZOOlanders\\YOOessentials\\Vendor\\NET_SSH2_LOGGING')) {
    ...
    {
        if (\defined('ZOOlanders\\YOOessentials\\Vendor\\NET_SSH2_LOGGING') && NET_SSH2_LOGGING == self::LOG_COMPLEX) {
