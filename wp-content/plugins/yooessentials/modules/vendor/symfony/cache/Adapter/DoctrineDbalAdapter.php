...
use ZOOlanders\YOOessentials\Vendor\Doctrine\DBAL\ArrayParameterType;
use ZOOlanders\YOOessentials\Vendor\Doctrine\DBAL\Configuration;
use ZOOlanders\YOOessentials\Vendor\Doctrine\DBAL\Connection;
use ZOOlanders\YOOessentials\Vendor\Doctrine\DBAL\Driver\ServerInfoAwareConnection;
use ZOOlanders\YOOessentials\Vendor\Doctrine\DBAL\DriverManager;
use ZOOlanders\YOOessentials\Vendor\Doctrine\DBAL\Exception as DBALException;
use ZOOlanders\YOOessentials\Vendor\Doctrine\DBAL\Exception\TableNotFoundException;
use ZOOlanders\YOOessentials\Vendor\Doctrine\DBAL\ParameterType;
use ZOOlanders\YOOessentials\Vendor\Doctrine\DBAL\Schema\DefaultSchemaManagerFactory;
use ZOOlanders\YOOessentials\Vendor\Doctrine\DBAL\Schema\Schema;
use ZOOlanders\YOOessentials\Vendor\Doctrine\DBAL\ServerVersionProvider;
use ZOOlanders\YOOessentials\Vendor\Doctrine\DBAL\Tools\DsnParser;
...
class DoctrineDbalAdapter extends AbstractAdapter implements PruneableInterface
{
    ...
    private function getPlatformName() : string
    {
        ...
        switch (\true) {
            case $platform instanceof \ZOOlanders\YOOessentials\Vendor\Doctrine\DBAL\Platforms\MySQLPlatform:
            case $platform instanceof \ZOOlanders\YOOessentials\Vendor\Doctrine\DBAL\Platforms\MySQL57Platform:
                return $this->platformName = 'mysql';
            case $platform instanceof \ZOOlanders\YOOessentials\Vendor\Doctrine\DBAL\Platforms\SqlitePlatform:
                return $this->platformName = 'sqlite';
            case $platform instanceof \ZOOlanders\YOOessentials\Vendor\Doctrine\DBAL\Platforms\PostgreSQLPlatform:
            case $platform instanceof \ZOOlanders\YOOessentials\Vendor\Doctrine\DBAL\Platforms\PostgreSQL94Platform:
                return $this->platformName = 'pgsql';
            case $platform instanceof \ZOOlanders\YOOessentials\Vendor\Doctrine\DBAL\Platforms\OraclePlatform:
                return $this->platformName = 'oci';
            case $platform instanceof \ZOOlanders\YOOessentials\Vendor\Doctrine\DBAL\Platforms\SQLServerPlatform:
            case $platform instanceof \ZOOlanders\YOOessentials\Vendor\Doctrine\DBAL\Platforms\SQLServer2012Platform:
