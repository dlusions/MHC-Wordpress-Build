...
class CouchbaseBucketAdapter extends AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\ZOOlanders\YOOessentials\Vendor\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, ?MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []) : \ZOOlanders\YOOessentials\Vendor\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \ZOOlanders\YOOessentials\Vendor\CouchbaseCluster($connectionString);
