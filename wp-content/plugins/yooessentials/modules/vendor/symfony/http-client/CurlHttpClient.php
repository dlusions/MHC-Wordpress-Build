...
use ZOOlanders\YOOessentials\Vendor\Symfony\Component\HttpClient\Internal\PushedResponse;
use ZOOlanders\YOOessentials\Vendor\Symfony\Component\HttpClient\Response\CurlResponse;
    ...
    public function request(string $method, string $url, array $options = []) : ResponseInterface
    {
        ...
        if ($options['bindto']) {
            if (\file_exists($options['bindto'])) {
                ...
                $curlopts[\CURLOPT_INTERFACE] = \trim($matches[1], '[]');
