...
use ZOOlanders\YOOessentials\Vendor\Symfony\Component\HttpClient\Chunk\DataChunk;
...
trait TransportResponseTrait
{
     ...
     */
    protected static abstract function perform(ClientState $multi, array &$responses) : void;
    /**
     * Waits for network activity.
     */
    protected static abstract function select(ClientState $multi, float $timeout) : int;
