...
final class FactorException extends ValidationException
{
     ...
     * {@inheritDoc}
     */
    protected $defaultTemplates = [self::MODE_DEFAULT => [self::STANDARD => '{{name}} must be a factor of {{dividend}}'], self::MODE_NEGATIVE => [self::STANDARD => '{{name}} must not be a factor of {{dividend}}']];
}
