...
final class Base64Exception extends ValidationException
{
     ...
     * {@inheritDoc}
     */
    protected $defaultTemplates = [self::MODE_DEFAULT => [self::STANDARD => '{{name}} must be Base64-encoded'], self::MODE_NEGATIVE => [self::STANDARD => '{{name}} must not be Base64-encoded']];
}
