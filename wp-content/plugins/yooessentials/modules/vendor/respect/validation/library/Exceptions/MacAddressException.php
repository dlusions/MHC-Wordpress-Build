...
final class MacAddressException extends ValidationException
{
     ...
     * {@inheritDoc}
     */
    protected $defaultTemplates = [self::MODE_DEFAULT => [self::STANDARD => '{{name}} must be a valid MAC address'], self::MODE_NEGATIVE => [self::STANDARD => '{{name}} must not be a valid MAC address']];
}
