...
final class PisException extends ValidationException
{
     ...
     * {@inheritDoc}
     */
    protected $defaultTemplates = [self::MODE_DEFAULT => [self::STANDARD => '{{name}} must be a valid PIS number'], self::MODE_NEGATIVE => [self::STANDARD => '{{name}} must not be a valid PIS number']];
}
