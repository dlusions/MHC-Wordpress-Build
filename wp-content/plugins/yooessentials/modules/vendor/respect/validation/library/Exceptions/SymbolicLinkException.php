...
final class SymbolicLinkException extends ValidationException
{
     ...
     * {@inheritDoc}
     */
    protected $defaultTemplates = [self::MODE_DEFAULT => [self::STANDARD => '{{name}} must be a symbolic link'], self::MODE_NEGATIVE => [self::STANDARD => '{{name}} must not be a symbolic link']];
}
