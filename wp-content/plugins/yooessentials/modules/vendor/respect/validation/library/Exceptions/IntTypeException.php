...
final class IntTypeException extends ValidationException
{
     ...
     * {@inheritDoc}
     */
    protected $defaultTemplates = [self::MODE_DEFAULT => [self::STANDARD => '{{name}} must be of type integer'], self::MODE_NEGATIVE => [self::STANDARD => '{{name}} must not be of type integer']];
}
