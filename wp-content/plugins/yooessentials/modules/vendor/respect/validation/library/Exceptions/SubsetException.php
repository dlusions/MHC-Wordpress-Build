...
final class SubsetException extends ValidationException
{
     ...
     * {@inheritDoc}
     */
    protected $defaultTemplates = [self::MODE_DEFAULT => [self::STANDARD => '{{name}} must be subset of {{superset}}'], self::MODE_NEGATIVE => [self::STANDARD => '{{name}} must not be subset of {{superset}}']];
}
