...
final class HexRgbColorException extends ValidationException
{
     ...
     * {@inheritDoc}
     */
    protected $defaultTemplates = [self::MODE_DEFAULT => [self::STANDARD => '{{name}} must be a hex RGB color'], self::MODE_NEGATIVE => [self::STANDARD => '{{name}} must not be a hex RGB color']];
}
