...
final class CnpjException extends ValidationException
{
     ...
     * {@inheritDoc}
     */
    protected $defaultTemplates = [self::MODE_DEFAULT => [self::STANDARD => '{{name}} must be a valid CNPJ number'], self::MODE_NEGATIVE => [self::STANDARD => '{{name}} must not be a valid CNPJ number']];
}
