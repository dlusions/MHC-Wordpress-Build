...
namespace ZOOlanders\YOOessentials\Vendor\GeoIp2\WebService;

use ZOOlanders\YOOessentials\Vendor\GeoIp2\Exception\AddressNotFoundException;
use ZOOlanders\YOOessentials\Vendor\GeoIp2\Exception\AuthenticationException;
use ZOOlanders\YOOessentials\Vendor\GeoIp2\Exception\GeoIp2Exception;
use ZOOlanders\YOOessentials\Vendor\GeoIp2\Exception\HttpException;
use ZOOlanders\YOOessentials\Vendor\GeoIp2\Exception\InvalidRequestException;
use ZOOlanders\YOOessentials\Vendor\GeoIp2\Exception\OutOfQueriesException;
use ZOOlanders\YOOessentials\Vendor\GeoIp2\Model\City;
use ZOOlanders\YOOessentials\Vendor\GeoIp2\Model\Country;
use ZOOlanders\YOOessentials\Vendor\GeoIp2\Model\Insights;
use ZOOlanders\YOOessentials\Vendor\GeoIp2\ProviderInterface;
use ZOOlanders\YOOessentials\Vendor\MaxMind\WebService\Client as WsClient;
/**
...
class Client implements ProviderInterface
{
    ...
    private function responseFor(string $endpoint, string $class, string $ipAddress) : Country
    {
        ...
        } catch (\ZOOlanders\YOOessentials\Vendor\MaxMind\Exception\IpAddressNotFoundException $ex) {
            throw new AddressNotFoundException($ex->getMessage(), $ex->getStatusCode(), $ex);
        } catch (\ZOOlanders\YOOessentials\Vendor\MaxMind\Exception\AuthenticationException $ex) {
            throw new AuthenticationException($ex->getMessage(), $ex->getStatusCode(), $ex);
        } catch (\ZOOlanders\YOOessentials\Vendor\MaxMind\Exception\InsufficientFundsException $ex) {
            throw new OutOfQueriesException($ex->getMessage(), $ex->getStatusCode(), $ex);
        } catch (\ZOOlanders\YOOessentials\Vendor\MaxMind\Exception\InvalidRequestException $ex) {
            throw new InvalidRequestException($ex->getMessage(), $ex->getErrorCode(), $ex->getStatusCode(), $ex->getUri(), $ex);
        } catch (\ZOOlanders\YOOessentials\Vendor\MaxMind\Exception\HttpException $ex) {
            throw new HttpException($ex->getMessage(), $ex->getStatusCode(), $ex->getUri(), $ex);
        } catch (\ZOOlanders\YOOessentials\Vendor\MaxMind\Exception\WebServiceException $ex) {
