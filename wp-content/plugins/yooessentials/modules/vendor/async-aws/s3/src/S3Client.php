...
namespace ZOOlanders\YOOessentials\Vendor\AsyncAws\S3;
...
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Enum\BucketCannedACL;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Enum\ChecksumAlgorithm;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Enum\ChecksumMode;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Enum\EncodingType;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Enum\MetadataDirective;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Enum\ObjectCannedACL;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Enum\ObjectLockLegalHoldStatus;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Enum\ObjectLockMode;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Enum\ObjectOwnership;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Enum\RequestPayer;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Enum\ServerSideEncryption;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Enum\StorageClass;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Enum\TaggingDirective;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Exception\BucketAlreadyExistsException;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Exception\BucketAlreadyOwnedByYouException;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Exception\InvalidObjectStateException;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Exception\NoSuchBucketException;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Exception\NoSuchKeyException;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Exception\NoSuchUploadException;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Exception\ObjectNotInActiveTierErrorException;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Input\AbortMultipartUploadRequest;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Input\CompleteMultipartUploadRequest;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Input\CopyObjectRequest;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Input\CreateBucketRequest;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Input\CreateMultipartUploadRequest;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Input\DeleteBucketCorsRequest;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Input\DeleteBucketRequest;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Input\DeleteObjectRequest;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Input\DeleteObjectsRequest;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Input\GetBucketCorsRequest;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Input\GetBucketEncryptionRequest;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Input\GetObjectAclRequest;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Input\GetObjectRequest;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Input\HeadBucketRequest;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Input\HeadObjectRequest;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Input\ListBucketsRequest;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Input\ListMultipartUploadsRequest;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Input\ListObjectsV2Request;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Input\ListPartsRequest;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Input\PutBucketCorsRequest;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Input\PutBucketNotificationConfigurationRequest;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Input\PutObjectAclRequest;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Input\PutObjectRequest;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Input\UploadPartRequest;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Result\AbortMultipartUploadOutput;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Result\BucketExistsWaiter;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Result\BucketNotExistsWaiter;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Result\CompleteMultipartUploadOutput;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Result\CopyObjectOutput;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Result\CreateBucketOutput;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Result\CreateMultipartUploadOutput;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Result\DeleteObjectOutput;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Result\DeleteObjectsOutput;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Result\GetBucketCorsOutput;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Result\GetBucketEncryptionOutput;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Result\GetObjectAclOutput;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Result\GetObjectOutput;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Result\HeadObjectOutput;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Result\ListBucketsOutput;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Result\ListMultipartUploadsOutput;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Result\ListObjectsV2Output;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Result\ListPartsOutput;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Result\ObjectExistsWaiter;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Result\ObjectNotExistsWaiter;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Result\PutObjectAclOutput;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Result\PutObjectOutput;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Result\UploadPartOutput;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Signer\SignerV4ForS3;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\ValueObject\AccessControlPolicy;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\ValueObject\CompletedMultipartUpload;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\ValueObject\CORSConfiguration;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\ValueObject\CreateBucketConfiguration;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\ValueObject\Delete;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\ValueObject\MultipartUpload;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\ValueObject\NotificationConfiguration;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\ValueObject\Part;
