...
use ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\EndpointDiscovery\EndpointInterface;
...
use ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\HttpClient\AwsRetryStrategy;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\Signer\Signer;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\Signer\SignerV4;
use ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\Stream\StringStream;
...
abstract class AbstractApi
{
    ...
    public final function presign(Input $input, ?\DateTimeImmutable $expires = null) : string
    {
    ...
    protected final function getResponse(Request $request, ?RequestContext $context = null) : Response
    {
