...
class RemoveDuplicatedDynamicQueries extends AbstractMigration implements MigrationInterface
{
    public const VERSION = '2.2.20';

    public function migrateConfig(array $config): array
    {
        $entries = Arr::get($config, 'dynamic.queries', []);
        ...
        Arr::set($config, 'dynamic.queries', $entries);
